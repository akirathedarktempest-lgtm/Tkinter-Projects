...
Button0=Button(root,text="0",command=zero,state=DISABLED,padx=20,pady=15)
Button0.grid(row=1,column=1)
Button1=Button(root,text="1",command=one,padx=20,pady=15)
Button1.grid(row=1,column=2)
Button2=Button(root,text="2",command=two,padx=20,pady=15)
Button2.grid(row=1,column=3)
Button3=Button(root,text="3",command=three,padx=20,pady=15)
Button3.grid(row=2,column=1)
Button4=Button(root,text="4",command=four,padx=20,pady=15)
Button4.grid(row=2,column=2)
Button5=Button(root,text="5",command=five,padx=20,pady=15)
Button5.grid(row=2,column=3)
Button6=Button(root,text="6",command=six,padx=20,pady=15)
Button6.grid(row=3,column=1)
Button7=Button(root,text="7",command=seven,padx=20,pady=15)
Button7.grid(row=3,column=2)
Button8=Button(root,text="8",command=eight,padx=20,pady=15)
Button8.grid(row=3,column=3)
Button9=Button(root,text="9",command=nine,padx=20,pady=15)
Button9.grid(row=4,column=1)
Buttonadd=Button(root,text="+",command=add,state=DISABLED,padx=20,pady=15)#we are making it disable from the beginning, so that it wouldn't start like +1+2, no
Buttonadd.grid(row=4,column=2)#we need to only activate it when a number is there and the last value wasn't +,-,*,/
Buttonequal=Button(root,text="=",command=equal,state=DISABLED,padx=20,pady=15)
Buttonequal.grid(row=4,column=3)
Buttonminus=Button(root,text="-",command=minus,state=DISABLED,padx=20,pady=15)
Buttonminus.grid(row=5,column=1)
Buttonmultiply=Button(root,text="*",command=multiply,state=DISABLED,padx=20,pady=15)
Buttonmultiply.grid(row=5,column=2)
Buttondivide=Button(root,text="/",command=divide,state=DISABLED,padx=20,pady=15)
Buttondivide.grid(row=5,column=3)
myLabel.grid(row=0,column=0,columnspan=3)#changed row and column as 
